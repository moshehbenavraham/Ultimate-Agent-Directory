...
> **Looking for AI agent frameworks and tools?** Check out our [AI Agent Directory](README.md) with 712 curated entries!
...
| [**Vercel AI Chatbot**](https://github.com/vercel/chatbot) | 20.2K | - | Hackable Next.js AI chatbot template from Vercel built with the AI SDK, multi-provider model support, chat history persistence, blob storage,... |
| [**Vercel SaaS Starter (Next.js SaaS Starter)**](https://github.com/nextjs/saas-starter) | 15.7K | MIT | Official Next.js pattern from Vercel, minimal but authoritative. Intentionally minimal, serving as a clean foundation to build upon. |
...
| [**ixartz SaaS-Boilerplate**](https://github.com/ixartz/SaaS-Boilerplate) | 7.0K | MIT | Modern App Router implementation with multi-tenancy support. |
...
| [**AI Starter Kit for Next.js**](https://github.com/AIStarterKit/ai-saas-starter-kit-nextjs) | 35 | MIT | Open-source AI SaaS starter for Next.js with Tailwind CSS, Drizzle, NextAuth, Stripe, and AI API integrations for text, image, code, and video... |
...
| [**ACME SaaS AI Chat Boilerplate**](https://github.com/vmnog/saas-ai-boilerplate) | - | - | Next.js and Fastify SaaS AI chat boilerplate with OpenAI streaming, magic-link authentication, Stripe subscriptions, multi-tenant usage limits,... |
...
| [**Vercel AI SDK Reasoning Starter**](https://github.com/vercel-labs/ai-sdk-reasoning-starter) | - | - | Next.js chatbot starter from Vercel Labs designed for reasoning models, with AI SDK integrations, multi-provider model support, streaming UI,... |
| [**Vercel Gemini Chatbot**](https://github.com/vercel-labs/gemini-chatbot) | - | - | Vercel Labs Next.js AI chatbot template using the AI SDK with Gemini defaults, alternative provider support, chat history persistence, blob... |
...
| Name | Stars | License | Description |
|------|-------|---------|-------------|
| [**Remix Framework**](https://github.com/remix-run/remix) | 32.7K | MIT | Full-stack React framework with web standards-first philosophy and multi-runtime support. |
...
| [**Open SaaS**](https://github.com/wasp-lang/open-saas) | 14.3K | MIT | Best free complete SaaS starter. Represents a shift towards "configuration-as-code" frameworks. Built on Wasp, a distinct DSL (Domain Specific... |
...
| [**SupaNuxt SaaS**](https://github.com/JavascriptMick/supanuxt-saas) | 520 | MIT | Comprehensive boilerplate for the "Supa-stack" (Supabase + Nuxt), bringing TypeScript full-stack development to Vue. A Vue counterpart to the... |
...
| Name | Stars | License | Description |
|------|-------|---------|-------------|
| [**Payload CMS**](https://github.com/payloadcms/payload) | 42.1K | MIT | Modern Node.js headless CMS with TypeScript-first approach, code-first schema definition, and built-in authentication with React admin panel. |
...
| [**Directus**](https://github.com/directus/directus) | 35K | BSL-1.1 | Open-source data platform and headless CMS with REST and GraphQL APIs auto-generated from database schema, Vue.js admin dashboard, and SQL... |
...
| [**Extro (TurboStarter)**](https://github.com/turbostarter/extro) | 380 | MIT | Specialized starter for building cross-browser extensions supporting Chrome, Firefox, and Edge with WXT framework and hot-reloading. |
...
| [**Nelysia**](https://github.com/ByteHolic/Nelysia) | 4 | MIT | NestJS-style modular framework starter built on Elysia and Bun, with controller, service, and dependency-injection patterns plus guards,... |
...
| Name | Stars | License | Description |
|------|-------|---------|-------------|
| [**Starlight**](https://github.com/withastro/starlight) | 8.4K | MIT | Official Astro documentation site template with sidebar navigation, search, i18n, Markdown and MDX content support, dark-mode UI, and docs-focused... |
| [**AstroWind**](https://github.com/arthelokyo/astrowind) | 5.6K | MIT | Feature-rich Astro and Tailwind CSS template for websites and SaaS landing pages, with blog support, i18n, SEO, multiple page layouts, dark-mode... |
...
| Name | Stars | License | Description |
|------|-------|---------|-------------|
| [**Full Stack FastAPI Template (Tiangolo)**](https://github.com/fastapi/full-stack-fastapi-template) | 42.9K | MIT | Popular full-stack FastAPI template (40k+ stars) that defines a standard for modern Python web development. |
| [**FastAPI Best Practices**](https://github.com/zhanymkanov/fastapi-best-practices) | 17.2K | - | Community-maintained FastAPI architecture reference covering project structure, async patterns, dependency injection, background tasks, security,... |
| [**Full Stack AI Agent Template**](https://github.com/vstorm-co/full-stack-ai-agent-template) | 1.2K | MIT | Production-ready FastAPI and Next.js AI agent template with multiple agent frameworks, RAG pipelines, streaming chat, JWT/OAuth authentication,... |
| [**FastAPI Microservices**](https://github.com/Kludex/fastapi-microservices) | 541 | MIT | FastAPI microservices template showing async service structure, database migrations, Docker Compose orchestration, and inter-service HTTP... |
...
| Name | Stars | License | Description |
|------|-------|---------|-------------|
| [**Filament**](https://github.com/filamentphp/filament) | 30.6K | MIT | Laravel admin panel and application builder with Livewire-powered resources, forms, tables, actions, notifications, dashboards, and CRUD tooling... |
...
| [**nunomaduro/laravel-starter-kit**](https://github.com/nunomaduro/laravel-starter-kit) | 852 | MIT | Ultra-strict TypeScript Laravel starter. |
| [**laravel/react-starter-kit (Official)**](https://github.com/laravel/react-starter-kit) | 828 | MIT | Official Laravel starter with React 19 and modern tooling. |
| [**laravel/vue-starter-kit (Official)**](https://github.com/laravel/vue-starter-kit) | 608 | MIT | Official Laravel starter with Vue 3 and Inertia. |
...
| [**Phlex Rails**](https://github.com/yippee-fun/phlex-rails) | 360 | MIT | Rails integration for Phlex view components, enabling Ruby object views as an alternative to ERB with composable, testable components for modern... |
...
| [**ReactifyRails**](https://github.com/akhilgkrishnan/Rails-React-Boilerplate) | - | MIT | Rails and React integration starter with Shakapacker for modern JavaScript bundling in Rails 7+ applications. Includes TypeScript, Tailwind CSS,... |
...
| Name | Stars | License | Description |
|------|-------|---------|-------------|
| [**PocketBase**](https://github.com/pocketbase/pocketbase) | 58.1K | MIT | Go backend framework with embedded SQLite database, realtime subscriptions, REST APIs, file storage, authentication, admin UI, and an embeddable... |
| [**Encore**](https://github.com/encoredev/encore) | 11.9K | MPL-2.0 | Backend development platform and Go framework with type-safe APIs, built-in infrastructure provisioning, secrets management, distributed tracing,... |
...
| Name | Stars | License | Description |
|------|-------|---------|-------------|
| [**Dioxus**](https://github.com/DioxusLabs/dioxus) | 35.9K | MIT | Full-stack Rust for web, desktop, and mobile from one codebase. |
...
| [**Rustzen Admin**](https://github.com/idaibin/rustzen-admin) | 151 | MIT | Decoupled starter focusing on the React/Rust interface. |
| [**Leptos start-axum (Official)**](https://github.com/leptos-rs/start-axum) | 75 | Unlicense | Official Leptos template with Axum backend. |
...
| Name | Stars | License | Description |
|------|-------|---------|-------------|
| [**Clean Architecture by Jason Taylor**](https://github.com/jasontaylordev/CleanArchitecture) | 20K | MIT | ASP.NET Core Clean Architecture template with CQRS, MediatR-style application layers, validation, Entity Framework Core, identity management, and... |
| [**eShop**](https://github.com/dotnet/eShop) | 10.4K | MIT | Official Microsoft reference microservices application using .NET Aspire, multiple services, event-driven architecture, CQRS-style patterns,... |
...
| [**NetCoreTemplates React SPA**](https://github.com/NetCoreTemplates/react-spa) | 55 | MIT | Modern .NET 10 + React 19 starter with ServiceStack integration. |
| [**ABP Framework**](https://github.com/abpframework/abp) | - | - | Modular ASP.NET Core application framework and startup template ecosystem with DDD patterns, multi-tenancy, authorization, UI options, background... |
...
| [**MakerKit Expo Supabase Kit**](https://github.com/makerkit/react-native-expo-turbo-saas-kit) | 123 | MIT | MakerKit Expo and React Native starter with Supabase auth, protected routes, TypeScript, user profile management, and shared conventions intended... |
| [**Expo Supabase Starter Kit**](https://github.com/robertguss/expo-supabase-starter-kit) | - | - | Expo and React Native starter with Supabase auth, Expo Router, NativeWind-style styling, cached data fetching, state management, analytics,... |
...
| [**Solito**](https://github.com/nandorojo/solito) | - | - | Cross-platform React Native and Next.js starter toolkit for sharing navigation and routing patterns between Expo native apps and web applications... |
...
| Name | Stars | License | Description |
|------|-------|---------|-------------|
| [**Obytes Starter**](https://github.com/obytes/react-native-template-obytes) | 4.1K | - | Focused on the Expo ecosystem with modern tooling. |
